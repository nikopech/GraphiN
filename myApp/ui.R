shinyUI(fluidPage(theme=shinytheme(theme="flatly"),
                  navbarPage("Biograph",
                             
                             tabPanel("Graph Creation",
                                      fluidRow(add_busy_bar(color = "#FF0000"),
                                               # add_busy_gif(src = "https://media.giphy.com/media/tXL4FHPSnVJ0A/giphy.gif", 
                                               ...
                                               sidebarLayout(sidebarPanel(width=2,
                                                                          ...
                                                                          br(),br(),br(),br(),
                                                                          selectInput("seqSelect","Select the column of the sequence",
                                                                                      choices=list("IMGT.gapped.nt.sequences.V.D.J.REGION"="IMGT.gapped.nt.sequences.V.D.J.REGION",
                                                                          ...
                                                                          selectInput("simSelect","Select the similarity metric",
                                                             ...
                                                             mainPanel(tabsetPanel(
                                                               tabPanel("Graph",
                                                                        ...
                                                                        column(7,div(style = "position:absolute;right:2em;",
                                                                                     br(),
                                                               ...
                                                               tabPanel("Data",
                                                                        ...
                                                                        dataTableOutput("dataset")),   # downloadButton("downloadGraph", "Download Graph")
                                                               
                                                               tabPanel("Adjacency",dataTableOutput("adj")),
                                                               
                                                               tabPanel("Unique Combo", dataTableOutput("uni")))))),
                                      ...
                                      h3("Filters"), 
                                      column(5, fluidRow(style="background-color:rgb(238, 239, 239);border-radius:5px;border-color=LightGrey;border-color=Black;border-width=thick;",
                                                         br(),
                                                         fluidRow(column(4, uiOutput("selectbox1"), uiOutput("textbox1"),
                                                                         br(),
                                                                  ...
                                                                  column(8, h4("Filters Used"), tableOutput("filtertable"))),
                             ...
                             tabPanel("MST",
                                      fluidRow(# add_busy_gif(src = "https://media.giphy.com/media/tXL4FHPSnVJ0A/giphy.gif", height = 120, width = 120),
                                        column(10, div(style = "position:absolute;right:1em;", 
                                      ...
                                      fluidRow(actionButton("centralButton","Calculate Centralities"),
                                               ...
                                               tabsetPanel(tabPanel("Centralities",DT::dataTableOutput("Centralities")),
                                                           ...
                                                           tabPanel("Network",
                                                                    ...
                                                                    column(2,checkboxInput("clusterCentral","Coloring according to clustering",
                                                                                           value=FALSE),
                                                                           selectInput("centralColor","Select an attribute for nodes color",
                                                                                       choice=list("no attr"="")),
                                                                           plotOutput("centralLegend",width=300)))))),
                             ...
                             tabPanel("Clustering",
                                      fluidRow(tabsetPanel(
                                        tabPanel("Clustering Analysis",
                                                 ...
                                                 fluidRow(column(8,div(style = "position:absolute;right:1em;",
                                        ...
                                        tabPanel("Clustering Crossover",
                                                 ...
                                                 fluidRow(column(2, DT::dataTableOutput("confusionMatrix1")),
                                                          ...
                                                          column(4, verbatimTextOutput("metrics2"), 
                                                                 ...
                                                                 selectInput("heatSelect",label="",
                                                                             choices=list("Overall"=0,
                                                                                          ...
                                                                                          "Conditional under clustering 2"=2),selected=0),
